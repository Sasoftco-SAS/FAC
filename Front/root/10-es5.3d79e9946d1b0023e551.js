(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[10], {
    ...
    /***/
    function DPNA(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "FirmasHomeComponent", function () {
      ...
      var _lista_proyectos_modal_lista_proyectos_modal_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../lista-proyectos-modal/lista-proyectos-modal.component */
      "a8lz");
      /* harmony import */


      var _shared_services_firma_firma_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../../../shared/services/firma/firma.service */
      "KdIk");
      /* harmony import */
      ...
      var _admin_convocatory_services_convocatory_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../admin/convocatory/services/convocatory.service */
      "lDoA");
      /* harmony import */
      ...
      function FirmasHomeComponent_button_15_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function FirmasHomeComponent_button_15_Template_button_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10);

            var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r9.updateSignature();
          });
      ...
      function FirmasHomeComponent_button_16_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function FirmasHomeComponent_button_16_Template_button_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12);

            var ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r11.addSignature();
          });
      ...
      function FirmasHomeComponent_div_24_td_10_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function FirmasHomeComponent_div_24_td_10_Template_button_click_3_listener() {
            ...
            return ctx_r24.viewConvocatorias(row_r23._id);
          });
      ...
      var FirmasHomeComponent = /*@__PURE__*/function () {
        var FirmasHomeComponent = /*#__PURE__*/function () {
          function FirmasHomeComponent(firmaService, authService, convocatoryService, dialog) {
            _classCallCheck(this, FirmasHomeComponent);
          ...
          _createClass(FirmasHomeComponent, [{
            key: "ngOnInit",
            ...
            value: function addSignature() {
              ...
              this.firmaService.saveFirma(this.fileToUpload, this.userId).subscribe(function (response) {
                _this.hasSignature = true;
                _this.signature = response.firma;
            ...
            value: function updateSignature() {
              ...
              this.firmaService.removeFirma(this.userId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["finalize"])(function () {
                return _this2.addSignature();
              })).subscribe(function () {});
            }
          }, {
            key: "saveSignature",
            value: function saveSignature(files) {
            ...
            key: "viewConvocatorias",
            value: function viewConvocatorias(id) {
              var data = {
                idC: id
              };
              var dialogRef = this.dialog.open(_lista_proyectos_modal_lista_proyectos_modal_component__WEBPACK_IMPORTED_MODULE_2__["ListaProyectosModalComponent"], {
                data: data
              });
            ...
            value: function getUserId() {
              ...
              this.authService.getUserId().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["finalize"])(function () {
                return _this3.getSignature();
              })).subscribe(function (userId) {
                return _this3.userId = userId;
              }, function (error) {
                return console.log('error>>> ', error);
              });
            }
            ...
            value: function getSignature() {
              ...
              this.firmaService.getFirma(this.userId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["finalize"])(function () {
                return _this4.loadingUserId = false;
              })).subscribe(function (response) {
                _this4.hasSignature = true;
                _this4.signature = response.firma;
              }, function (error) {
                return console.log('error>>> ', error);
              });
            }
          }, {
            key: "getConvocatorias",
            value: function getConvocatorias() {
              var _this5 = this;

              this.convocatoryService.getall().subscribe(function (convocatorias) {
                _this5.convocatorias = convocatorias.filter(function (r) {
        ...
        FirmasHomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
          ...
          template: function FirmasHomeComponent_Template(rf, ctx) {
            if (rf & 1) {
              ...
              _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function FirmasHomeComponent_Template_input_change_13_listener($event) {
                return ctx.saveSignature($event.target.files);
              });
    ...
    /***/
    function a8lz(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ListaProyectosModalComponent", function () {
      ...
      var _admin_Dialog_sucess_dialog_sucess_dialog_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../../admin/Dialog/sucess-dialog/sucess-dialog.component */
      "PrVi");
      /* harmony import */


      var _shared_services_Proyect_project_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../../../shared/services/Proyect/project.service */
      "OJh+");
      /* harmony import */
      ...
      var _shared_services_firma_firma_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../../shared/services/firma/firma.service */
      "KdIk");
      /* harmony import */
      ...
      function ListaProyectosModalComponent_mat_card_3_td_14_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListaProyectosModalComponent_mat_card_3_td_14_Template_button_click_3_listener() {
      ...
      var ListaProyectosModalComponent = /*@__PURE__*/function () {
        var ListaProyectosModalComponent = /*#__PURE__*/function () {
          function ListaProyectosModalComponent(data, projectService, router, authStorageService, dialogRef, dialog, firmaService, auth) {
            _classCallCheck(this, ListaProyectosModalComponent);
          ...
          _createClass(ListaProyectosModalComponent, [{
            key: "ngOnInit",
            value: function ngOnInit() {
            ...
            key: "firmar",
            value: function firmar(firma) {
              var _this6 = this;

              var idFirma = firma.idFirma,
                  idProyecto = firma.idProyecto;
              this.firmaService.firmar(idFirma, idProyecto).subscribe(function () {
                _this6.dialog.open(_admin_Dialog_sucess_dialog_sucess_dialog_component__WEBPACK_IMPORTED_MODULE_3__["SucessDialogComponent"], {
                  role: 'alertdialog',
                  autoFocus: false,
                  data: {
                    icono: 'done',
                    ...
                    descripcion: "El proyecto con nombre ".concat(firma.nombreProyecto, " se ha firmado exitosamente como ").concat(firma.name)
                  }
                }).afterClosed().subscribe(function () {
                  _this6.getAll(_this6.data.idC);
                });
              });
            }
          }, {
            ...
            value: function getAll(id) {
              ...
              this.loading = true;
              this.projectService.getIdConv(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(function () {
                return _this7.loading = false;
              })).subscribe(function (response) {
                response.Proyectos.map(function (proyecto) {
                  proyecto.firmas.map(function (firma) {
                    if (firma.idQuienFirma === userId && !firma.status) {
                      var name = firma.name,
                          idQuienFirma = firma.idQuienFirma,
                          _id = firma._id;
                      var nombreProyecto = proyecto.iniciarProyecto[0].nombreProyecto;

                      _this7.listadoDeFirma.push({
                        name: name,
                        idQuienFirma: idQuienFirma,
                ...
                if (localStorage.getItem('Role') === 'Investigador') {
                  response['Proyectos'].forEach(function (element) {
                    if (response['Proyectos'][0].UserId._id === _this7.authStorageService.getUserId()) {
                      _this7.dataSource = response['Proyectos'];
                    }
                  });
                } else {
                  _this7.dataSource = response['Proyectos'];
        ...
        ListaProyectosModalComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
          ...
          styles: [".table-proyectos-por-firmar {\n  width: 700px;\n}"]
        });
        return ListaProyectosModalComponent;
      }();
      /***/
    ...
    /***/
    function i258(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AgregarFirmaComponent", function () {
      ...
      var AgregarFirmaComponent = /*@__PURE__*/function () {
        var AgregarFirmaComponent = /*#__PURE__*/function () {
          function AgregarFirmaComponent() {
            _classCallCheck(this, AgregarFirmaComponent);
          }

          _createClass(AgregarFirmaComponent, [{
            key: "ngOnInit",
            value: function ngOnInit() {}
          }]);
        ...
        AgregarFirmaComponent.ɵfac = function AgregarFirmaComponent_Factory(t) {
          return new (t || AgregarFirmaComponent)();
        };

        AgregarFirmaComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
          type: AgregarFirmaComponent,
          selectors: [["app-agregar-firma"]],
          decls: 2,
          vars: 0,
          template: function AgregarFirmaComponent_Template(rf, ctx) {
            if (rf & 1) {
    ...
    /***/
    function rdqQ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "FirmasRoutingModule", function () {
      ...
      var _firmas_home_firmas_home_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./firmas-home/firmas-home.component */
      "DPNA");
      /* harmony import */


      var _agregar_firma_agregar_firma_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./agregar-firma/agregar-firma.component */
      "i258");
      ...
      var FirmasRoutingModule = /*@__PURE__*/function () {
        var FirmasRoutingModule = /*#__PURE__*/_createClass(function FirmasRoutingModule() {
          _classCallCheck(this, FirmasRoutingModule);
        });

        FirmasRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
          type: FirmasRoutingModule
        });
        FirmasRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
          factory: function FirmasRoutingModule_Factory(t) {
            return new (t || FirmasRoutingModule)();
          },
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](FirmasRoutingModule, {
    ...
    /***/
    function vISB(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "FirmasModule", function () {
        return FirmasModule;
      });
      /* harmony import */
      ...
      var _firmas_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./firmas.routing.module */
      "rdqQ");
      /* harmony import */
      ...
      var _lista_proyectos_modal_lista_proyectos_modal_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ./lista-proyectos-modal/lista-proyectos-modal.component */
      "a8lz");
      /* harmony import */
      ...
      var FirmasModule = /*@__PURE__*/function () {
        var FirmasModule = /*#__PURE__*/_createClass(function FirmasModule() {
          _classCallCheck(this, FirmasModule);
        });

        FirmasModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
          type: FirmasModule
        });
        FirmasModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
          factory: function FirmasModule_Factory(t) {
            return new (t || FirmasModule)();
          },
          imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MatDialogModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_5__["MatCardModule"], _firmas_routing_module__WEBPACK_IMPORTED_MODULE_4__["FirmasRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_8__["SharedModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_9__["MatTableModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_10__["MatButtonModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_11__["MatTooltipModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_12__["MatIconModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_14__["MatProgressSpinnerModule"]]]
        });
        return FirmasModule;
      }();

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](FirmasModule, {
          declarations: [_firmas_home_firmas_home_component__WEBPACK_IMPORTED_MODULE_2__["FirmasHomeComponent"], _agregar_firma_agregar_firma_component__WEBPACK_IMPORTED_MODULE_3__["AgregarFirmaComponent"], _lista_proyectos_modal_lista_proyectos_modal_component__WEBPACK_IMPORTED_MODULE_13__["ListaProyectosModalComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MatDialogModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_5__["MatCardModule"], _firmas_routing_module__WEBPACK_IMPORTED_MODULE_4__["FirmasRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_8__["SharedModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_9__["MatTableModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_10__["MatButtonModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_11__["MatTooltipModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_12__["MatIconModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_14__["MatProgressSpinnerModule"]]
        });
      })();
      /***/
