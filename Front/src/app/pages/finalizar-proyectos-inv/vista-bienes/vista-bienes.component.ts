...
@Component({
    selector: 'app-vista-bienes',
    templateUrl: './vista-bienes.component.html',
    styleUrls: ['./vista-bienes.component.scss']
})
export class VistaBienesComponent implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<VistaBienesComponent>) {
    }
    ...
    public getAll(): void {
        ...
        this.projectService.getById(this.data.idProyecto)
            ...
            .subscribe(r => {
                this.observaciones = r.Proyecto.observaciones_rubros;
                this.objeto_contrato = r.Proyecto.preguntasBienesyServicios[0].objeto_contrato;
                this.valor_estimado = r.Proyecto.preguntasBienesyServicios[0].valor_estimado;
                this.tipo_requerimiento = r.Proyecto.preguntasBienesyServicios[0].tipo_requerimiento;
                this.adm_recursos = r.Proyecto.preguntasBienesyServicios[0].adm_recursos;
                this.convenio = r.Proyecto.preguntasBienesyServicios[0].convenio;
                this.codigo = r.Proyecto.preguntasBienesyServicios[0].codigo;
                this.version = r.Proyecto.preguntasBienesyServicios[0].version;
                this.vigencia = r.Proyecto.preguntasBienesyServicios[0].vigencia;
                this.lugar_entrega = r.Proyecto.preguntasBienesyServicios[0].lugar_entrega;
                this.fecharequerida_actainicio = r.Proyecto.preguntasBienesyServicios[0].fecharequerida_actainicio;
                this.info_adicional = r.Proyecto.preguntasBienesyServicios[0].info_adicional;
                this.info_prov_nombre = r.Proyecto.preguntasBienesyServicios[0].info_prov_nombre;
                this.info_prov_ciudad = r.Proyecto.preguntasBienesyServicios[0].info_prov_ciudad;
                this.info_prov_direccion = r.Proyecto.preguntasBienesyServicios[0].info_prov_direccion;
                this.info_prov_numero = r.Proyecto.preguntasBienesyServicios[0].info_prov_numero;
                this.info_prov_correo = r.Proyecto.preguntasBienesyServicios[0].info_prov_correo;
