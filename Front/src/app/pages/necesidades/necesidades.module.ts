...
@NgModule({
  declarations: [NecesidadesHomeComponent, NecesidadesTableComponent], //Declarar componentes que voy a usar
    imports: [
        MatSortModule,
        CommonModule,
    ...
    exports : [
      NecesidadesTableComponent, NecesidadesHomeComponent, //Exportar los componentes que yo desee, luego en otro modulo debo importarlos
    ]
})
