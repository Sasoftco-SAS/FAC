...
export const MENU_INVESTIGADOR_ITEMS = [
    ...
    {name: 'Firmas', route: 'firmas', icon: 'border_color'},
    {name: 'Finalizar Proyectos', route: 'finalizar_proyectos', icon: 'vpn_key'},
    {name: 'Bienes/Servicios', route: 'bienes-servicios', icon: 'sell'}
];
...
export const MENU_RESPONSABLE_ITEMS = [
    ...
    {name: 'Firmas', route: 'firmas', icon: 'border_color'},
    {name: 'Finalizar Proyectos', route: 'finalizar_proyectos', icon: 'vpn_key'},
    {name: 'Bienes/Servicios', route: 'bienes-servicios', icon: 'sell'}//BORRAR PORQUE NO SE SI RESPONSABLE DEBE TENER ESTO PERO SE LO PUSE PORQUE MI USER GESTOR ACTI ES RESPONSABLE
];
